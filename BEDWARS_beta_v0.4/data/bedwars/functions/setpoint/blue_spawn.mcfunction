...
execute unless score playing num matches 1 run summon armor_stand ~ ~1 ~ {Tags:["bedwars","spawn"],Invisible:1b,NoGravity:1b,Marker:1b,CustomName:'{"text":"重生點","color":"blue"}',CustomNameVisible:1b}
