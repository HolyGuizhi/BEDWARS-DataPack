...
execute if score Generator_Tier num matches 4 run tellraw @a [{"text":" [BED WARS] ","color":"gold"},{"text":" 進入","color":"white"},{"text":"驟死賽","bold":true,"color":"red"},{"text":"！","color":"white"}]
