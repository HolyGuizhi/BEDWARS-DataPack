...
execute as @s[team=blue] if score blue_protect num matches 2 as @a[team=blue] at @s run playsound entity.experience_orb.pickup ambient @s ~ ~ ~
...
execute as @s[team=red] if score red_protect num matches 2 as @a[team=red] at @s run playsound entity.experience_orb.pickup ambient @s ~ ~ ~
...
execute as @s[team=yellow] if score yellow_protect num matches 2 as @a[team=yellow] at @s run playsound entity.experience_orb.pickup ambient @s ~ ~ ~
...
execute as @s[team=green] if score green_protect num matches 2 as @a[team=green] at @s run playsound entity.experience_orb.pickup ambient @s ~ ~ ~
execute as @s[team=green] if score green_protect num matches 2 run scoreboard players add @a[team=green] Armor 1
execute as @s[team=green] if score green_protect num matches 2 run scoreboard players set green_protect num 3
