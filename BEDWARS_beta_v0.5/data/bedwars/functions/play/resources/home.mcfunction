...
# 都在計時分數為1的時候生成 如果鐵錠已生成大約兩組以上都沒被拿走則不會生成
...
execute if score @s times matches 1 unless score @s Tmp matches 2.. run function bedwars:play/resources/generate_iron
execute if score @s deathcount matches 1 run function bedwars:play/resources/generate_gold
execute if score @s give_emerald matches 1 run function bedwars:play/resources/generate_emerald
