...
execute unless score playing num matches 1 align xz run summon armor_stand ~0.5 ~1 ~0.5 {Tags:["bedwars","resource","anti-stuck"],Invisible:1b,NoGravity:1b,Marker:1b,CustomName:'{"text":"資源生成點","color":"blue"}',CustomNameVisible:1b}
