...
execute unless score playing num matches 1 align xz run summon armor_stand ~0.5 ~1 ~0.5 {Tags:["bedwars","spawn","anti-stuck"],Invisible:1b,NoGravity:1b,Marker:1b,CustomName:'{"text":"重生點","color":"yellow"}',CustomNameVisible:1b}
