...
execute unless score @s Tmp matches 2.. run summon item ~ ~ ~ {Item:{id:"minecraft:gold_ingot",Count:1,tag:{game:1b}},Tags:["bedwars","no_loop"]}
execute if score @s Tmp matches 2.. run summon item ~ ~ ~ {Item:{id:"minecraft:gold_ingot",Count:1},Tags:["bedwars","cant_pickup"],PickupDelay:32767}
