...
- 切換多玩家物資獲取方式：<br>
  > 為指令使用介面的功能之一，啟用後能讓多個玩家同時吸取在 "隊伍資源生成點" 生成的物資，<br>
    如果不同隊伍內玩家的數量不一致，建議可以為了公平性而將此功能關閉。<br>
...
- 反卡死功能：
  > 針對如鑽石、綠寶石、隊伍資源等生成點，以及各隊伍重生點處，<br>
    在遊戲進行時，將無法在其附近3x3x3的範圍內，建築可從物品商人手中獲取的方塊。<br>
